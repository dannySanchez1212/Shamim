...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Owner - Edit') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('owner.update',$owner) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="company" type="text" class="form-control{{ $errors->has('company') ? ' is-invalid' : '' }}" name="company" value="{{ $owner->company }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div>
                                ...
                                <img class="img-responsive" src="{{asset('storage/logos')}}/{{$logo}}" width="70" height="auto">
                                
                                <input id="company_logoN" type="file" class="{{ $errors->has('company_logoN') ? ' is-invalid' : '' }}" name="company_logoN" accept="image/*">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ $owner->email }}" required>
                                @if ($errors->has('email'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="tel" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ $owner->phone }}" pattern="[0-9]{10}" required>
                                @if ($errors->has('phone'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address_line1" type="text" class="form-control{{ $errors->has('address_line1') ? ' is-invalid' : '' }}" name="address_line1" value="{{ $owner->address_line1 }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address_line2" type="text" class="form-control{{ $errors->has('address_line2') ? ' is-invalid' : '' }}" name="address_line2" value="{{ $owner->address_line2 }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="zip" type="text" class="form-control{{ $errors->has('zip') ? ' is-invalid' : '' }}" name="zip" value="{{ $owner->zip }}" required>
                                @if ($errors->has('zip'))
                                    <span class="invalid-feedback">
