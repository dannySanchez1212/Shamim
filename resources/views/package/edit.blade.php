...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Package - Edit') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('package.update',$package) }}">
                            ...
                            <div class="col-md-6">
                                <SELECT id='owner_id' name='owner_id' class="form-control" >
                                    ...
                                    @foreach($companys as $company)
                                        <option id='owner_id' value="{{ $company }}"  class="form-control{{ $errors->has('owner_id') ? ' is-invalid' : '' }}" required autofocus>{{ $company }}</option>
                                    @endforeach
                                </SELECT>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="user_group" type="text" class="form-control{{ $errors->has('user_group') ? ' is-invalid' : '' }}" name="user_group" value="{{ $package->user_group }}" required>
